...
- `AuthScreen.kt` — PAT setup screen: 4-step guided flow with help dialogs, URL parsing, scrollable, "Need help?" video link
- `SettingsScreen.kt` — Sign out, read-only repo display, two-step digital assistant setup (assistant role + side button), delete all data
