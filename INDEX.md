...
#### `ui/components/`
- `NoteTopBar.kt` — Top app bar with browse icon + settings gear (empty title; sticky topic display removed in M44)
...
- `docs/playstore/pre-launch-checklist.md` — Outstanding work between current state (closed testing) and v1.0 production release; tracks copy/branding cleanup, privacy policy hosting, asset re-shoot, Play Console forms, and the 14-day testing gate
